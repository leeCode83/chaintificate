...
export default function CreateCollectionPage() {
  ...
  const handleCreateCollection = async () => {
    ...
    try {
      await createCertificateCollection(
        collectionName,
        collectionSymbol,
        collectionDescription,
        collectionType
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-white via-blue-50 to-cyan-50 font-sans">
      ...
      {/* UPDATED: Increased padding-top to pt-32 (128px) to clear the header completely */}
      <main className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pt-32 pb-20">
        ...
        <div className="mb-8">
          ...
          <p className="text-gray-500 mt-1">
            Deploy a new smart contract for a certificate series
          </p>
        </div>
        ...
        <div className="bg-white rounded-xl shadow-lg p-8 md:p-12 border border-gray-100 max-w-3xl mx-auto">
          <div className="space-y-6">
            <div className="border-b border-gray-100 pb-6">
              ...
              <p className="text-gray-500 mt-1">
                Enter the details for your new certificate collection
              </p>
            </div>
            ...
            <div className="space-y-4">
              <div className="space-y-2">
                ...
                <p className="text-xs text-gray-400">
                  This will be the name of the NFT collection on the blockchain.
                </p>
              </div>
              ...
              <div className="space-y-2">
                ...
                />
                <p className="text-xs text-gray-400">
                  Short identifier for the collection (max 5 chars).
                </p>
              </div>
              ...
              <div className="space-y-4">
                ...
                <p className="text-xs text-gray-400">
                  Select the type of credentials this collection will issue.
                </p>
              </div>
            </div>
