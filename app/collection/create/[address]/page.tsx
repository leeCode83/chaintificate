...
export default function MintCertificatePage() {
  ...
  const handleMint = async () => {
    ...
    try {
      ...
      const tx = await createCertificate(
        address,
        recipientWallet,
        tokenURI,
        collection.name,
  ...
  if (isLoading) {
    return (
      <div className="min-h-screen bg-gradient-to-br from-white via-blue-50 to-cyan-50 font-sans">
        ...
        <main className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pt-24 pb-20 flex justify-center items-center h-[60vh]">
    ...
    return (
      <div className="min-h-screen bg-gradient-to-br from-white via-blue-50 to-cyan-50 font-sans">
        ...
        <main className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pt-24 pb-20">
          <div className="text-center text-red-500 bg-red-50 border border-red-200 p-4 rounded-xl">
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-white via-blue-50 to-cyan-50 font-sans">
      ...
      <main className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pt-24 pb-20">
        ...
        <div className="mb-8">
          <Link
            href={`/dashboard/institute/collection/${address}`}
              ...
              {previewUrl ? (
                <div className="absolute inset-0 w-full h-full flex items-center justify-center bg-gray-50 z-10">
                  ...
                  <div className="absolute inset-0 bg-black/50 opacity-0 group-hover:opacity-100 transition-opacity flex items-center justify-center pointer-events-none">
                    <p className="text-white font-medium px-4 py-2 rounded-full border border-white">
                      Change Image
                    </p>
                  </div>
                </div>
            ...
            <div className="flex flex-col justify-center space-y-6">
              ...
              <div className="pt-8 flex justify-end">
                <Button
                  ...
                  className="bg-[#007BFF] hover:bg-[#0056b3] text-white font-bold px-12 py-6 text-lg shadow-md transition-all rounded-lg w-full sm:w-auto flex items-center gap-2 justify-center"
                >
                  {(isUploading ||
                    isWritePending ||
                    isConfirming ||
