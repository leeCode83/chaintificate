  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-white via-blue-50 to-cyan-50 font-sans">
      ...
      <main className="pt-24 pb-20 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 animate-fade-in-up">
        ...
        {/* Header Section: Centered Info (Title Only) */}
        <div className="text-center space-y-6 mx-auto max-w-4xl mb-12">
          <h1 className="text-5xl font-black text-gray-900 leading-tight mb-6 tracking-tight">
            {certificate.name}
          </h1>
        </div>

        {/* Middle Section: Image and Verification Grid */}
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 mb-12">
          ...
          <div className="group relative h-full">
            ...
            <Card className="relative overflow-hidden border-2 border-blue-200 shadow-2xl bg-white/90 backdrop-blur-xl rounded-3xl h-full">
              <CardContent className="p-0 bg-gradient-to-br from-blue-50/50 to-cyan-50/30 flex items-center justify-center h-full min-h-[500px]">
                {certificate.image ? (
                  <img
          ...
          <div className="group relative h-full">
            ...
            <div className="relative bg-gradient-to-br from-blue-900 via-cyan-800 to-blue-900 p-10 rounded-3xl text-white shadow-2xl space-y-8 overflow-hidden h-full flex flex-col justify-center">
        ...
        {/* Bottom Section: Certificate Detail */}
        <div className="max-w-4xl mx-auto w-full">
          <div className="group relative">
            ...
            <div className="relative bg-white/90 backdrop-blur-xl p-10 rounded-3xl border-2 border-blue-200 shadow-xl space-y-6">
              <h3 className="font-black text-gray-900 text-xl flex items-center gap-3 border-b border-gray-100 pb-4">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6 pb-6 border-b border-gray-100">
                <div className="space-y-4">
                  <div>
                    ...
                    <span
                      className={`inline-block px-4 py-2 rounded-lg text-xs font-black uppercase tracking-wider shadow-sm
                  ...
                  <div>
                    ...
                    <span className="inline-flex items-center text-sm font-bold text-gray-700 bg-gray-50 px-4 py-2 rounded-lg border border-gray-200">
                ...
                <div>
                  ...
                  <div className="flex items-center gap-3 text-lg text-gray-800 font-bold bg-blue-50/50 p-4 rounded-xl border border-blue-100">
